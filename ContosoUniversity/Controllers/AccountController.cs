...
namespace ContosoUniversity.Controllers
{
    ...
    {
        private SchoolSignInManager _signInManager;
        private SchoolUserManager _userManager;

        public AccountController()
        {
        }

        public AccountController(SchoolUserManager userManager, SchoolSignInManager signInManager)
        {
            UserManager = userManager;
            SignInManager = signInManager;
        }

        public SchoolSignInManager SignInManager
        {
            get => _signInManager ?? HttpContext.GetOwinContext().Get<SchoolSignInManager>();
            private set => _signInManager = value;
        }

        public SchoolUserManager UserManager
        {
            get => _userManager ?? HttpContext.GetOwinContext().GetUserManager<SchoolUserManager>();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                var user = new SchoolUser {UserName = model.Email, Email = model.Email};
